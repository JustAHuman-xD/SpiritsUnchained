...
import me.justahuman.spiritsunchained.implementation.multiblocks.SpiritualAltarPiece;
...
public class Items {
    public static void setup(SlimefunAddon instance) {
        ...
        //Altar Blocks
        //Tier 1
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_QUARTZ_I, RecipeType.ANCIENT_ALTAR, new ItemStack[] {
        ...
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_STAIRS_I, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                null, null, null,
        ...
        //Tier 2
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_QUARTZ_II, RecipeType.ANCIENT_ALTAR, new ItemStack[] {
        ...
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_PILLAR_II, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ItemStacks.SUN_CHARGED_QUARTZ_II, null, null,
                null, null, null,
                null, null, null
        }, 1).register(instance);

        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_STAIRS_II, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                null, null, null,
        ...
        //Tier 3
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_QUARTZ_III, RecipeType.ANCIENT_ALTAR, new ItemStack[] {
        ...
        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_PILLAR_III, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ItemStacks.SUN_CHARGED_QUARTZ_III, null, null,
                null, null, null,
                null, null, null
        }, 1).register(instance);

        new SpiritualAltarPiece(ItemStacks.SUN_CHARGED_STAIRS_III, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                null, null, null,
        ...
        new SpiritualAltarPiece(ItemStacks.SUN_SMOOTH_CHARGED_QUARTZ_III, RecipeType.SMELTERY, new ItemStack[] {
                ItemStacks.SUN_CHARGED_QUARTZ_III, null, null,
                null, null, null,
                null, null, null
        }, 1).register(instance);

        new SpiritualAltarPiece(ItemStacks.SUN_SMOOTH_CHARGED_STAIRS_III, RecipeType.SMELTERY, new ItemStack[] {
