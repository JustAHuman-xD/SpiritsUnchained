...
public class SpiritualAltarPiece2 extends SlimefunItem {
    public SpiritualAltarPiece2(@Nonnull SlimefunItemStack item, @Nonnull RecipeType recipeType, @Nonnull ItemStack[] recipe, int amount) {
        super(Groups.SUN_ALTAR_2, item, recipeType, recipe, new SlimefunItemStack(item, amount));
    }
