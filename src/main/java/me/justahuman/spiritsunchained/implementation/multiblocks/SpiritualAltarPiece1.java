...
public class SpiritualAltarPiece1 extends SlimefunItem {
    public SpiritualAltarPiece1(@Nonnull SlimefunItemStack item, @Nonnull RecipeType recipeType, @Nonnull ItemStack[] recipe, int amount) {
        super(Groups.SUN_ALTAR_1, item, recipeType, recipe, new SlimefunItemStack(item, amount));
    }
